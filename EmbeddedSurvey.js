...
( function () {
	...
	function getSurveyStorageKey( name ) {
		// FIXME: redundant, but we want to be absolutely sure to namespace in case
		//  it's left off of the survey.name
	...
	function show() {
		// FIXME: Move back into class if it can be extracted into an external module protected from dependency loading.
